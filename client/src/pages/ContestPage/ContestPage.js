...
class ContestPage extends React.Component {
  ...
  render() {
    ...
    const offerTab = (<span onClick={() => changeContestViewMode(false)} className={classNames(styles.btn, { [styles.activeBtn]: !isBrief })}>Offer</span>);
    return (
      <div>
        {/* <Chat/> */}
        {isShowOnFull && (
                ...
                <div className={styles.mainInfoContainer}>
                  <div className={styles.infoContainer}>
                    <div className={styles.buttonsContainer}>
                      ...
                      {role === CONSTANTS.CUSTOMER && contestByIdStore && contestByIdStore.offers.length !== 0 ? offerTab : null}
                    </div>
                    {
                      isBrief
